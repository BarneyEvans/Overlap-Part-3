...
output_directory = r'C:\Users\evans\PycharmProjects\pythonProject\Overlap-Part-3\Better_Once\Organised_images'  # Replace with the directory where you want to save the images.
